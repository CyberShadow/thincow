...
( seq 1e99 || true ) | dd iflag=fullblock of=target/devs/test bs=$block_size count=2 status=none conv=notrunc
dd if=/dev/zero                           of=target/devs/test bs=$block_size count=2 status=none conv=notrunc
( seq 1e99 || true ) | dd iflag=fullblock of=target/devs/test bs=$block_size count=2 status=none conv=notrunc
